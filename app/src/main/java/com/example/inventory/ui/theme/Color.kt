...
val md_theme_light_primary = Color(0xFF008080) // changed to teal
val md_theme_light_onPrimary = Color(0xFF000000)//button add
val md_theme_light_primaryContainer = Color(0xFF708090) //button add
val md_theme_light_onPrimaryContainer = Color(0xFF22005D)
val md_theme_light_secondary = Color(0xFF008080)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFFA8072) //add items boxes
...
val md_theme_light_background = Color(0xFFC0C0C0) //all background
val md_theme_light_onBackground = Color(0xFF002022)
val md_theme_light_surface = Color(0xFFFFA500) // border where inventory Vault is
val md_theme_light_onSurface = Color(0xFF002022)
val md_theme_light_surfaceVariant = Color(0xFF008080) //change big box
val md_theme_light_onSurfaceVariant = Color(0xFF49454E)
val md_theme_light_outline = Color(0xFF7A757F)
val md_theme_light_inverseOnSurface = Color(0xFFE6E6FA)
val md_theme_light_inverseSurface = Color(0xFF00373A)
val md_theme_light_inversePrimary = Color(0xFF87CEEB)
val md_theme_light_surfaceTint = Color(0xFF6B3DD4)
val md_theme_light_outlineVariant = Color(0xFF87CEEB)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFF008080) // changed to teal
